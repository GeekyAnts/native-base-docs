...
[NativeBase](https://nativebase.io/) includes components such as anatomy of your app screens, header, textbox, buttons, badge, icon, form, checkbox, radio-button, list, card, thumbnail, spinner, layout, search bar etc.<br /><br />
